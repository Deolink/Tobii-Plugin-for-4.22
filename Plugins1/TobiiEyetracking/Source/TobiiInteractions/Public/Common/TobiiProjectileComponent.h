...
{
	Acceleration	//This is the default behavior. The projectile will accelerate towards the target. This also means the projectile will speed up. If this is not what you want, consider using another behavior.
	, Steering		//In this mode, imagine the projectile has side thrusters to enable it to turn gradually towards the target. This behavior preserves projectile speed.
};

UENUM()
enum class ETobiiProjectileGuidanceSystem
{
	Simple					//This is the default behavior. The projectile will home towards the target's last known location.
	, Prediction			//This mode will predict possible impact times and locations to avoid orbiting. Considers position, velocity and acceleration. Is quite expensive.
	, ComplexPrediction		//In addition to normal prediction, this guidance system mode will also calculate the closest approach if no direct hit is possible. More expensive than standard prediction
};
