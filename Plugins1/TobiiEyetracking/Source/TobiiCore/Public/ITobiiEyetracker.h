...
DECLARE_MULTICAST_DELEGATE_TwoParams(FTobiiEyetrackingTickedSignature, float, APlayerController*);
...
public:
	/**
	  * This function is meant to be used by other eyetracking modules that need to tick directly after eyetracking for best results.
	  *
	  * @returns				The tick event
	  */
	virtual FTobiiEyetrackingTickedSignature& GetTickEvent() = 0;
};
