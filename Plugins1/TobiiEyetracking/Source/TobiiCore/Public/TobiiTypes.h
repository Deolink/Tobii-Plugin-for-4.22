...
{
	CombinedGazeData = 1	UMETA(DisplayName = "Supports Combined Gaze Data")	/** This gaze tracker can deliver combined gaze data. */
	, LeftGazeData = 2		UMETA(DisplayName = "Supports Left Eye Gaze Data")	/** This gaze tracker can deliver individual gaze data for the left eye. */
	, RightGazeData = 4		UMETA(DisplayName = "Supports Right Eye Gaze Data")	/** This gaze tracker can deliver individual gaze data for the right eye. */
};
