...
#define TGI_VERSION_MAJOR 3
#define TGI_VERSION_MINOR 2
...
#define GENERATE_STRING(STRING) #STRING,
    ...
    struct TGI_TYPE_EXPORT IStatisticsRecorder
    {
        virtual const char* GetLiteral(StatisticsLiteral literal) const = 0;
        virtual bool RecordStatistics(const char* key, const char* value) = 0;
    };

    struct TGI_TYPE_EXPORT IFeaturesEnabledSettings
    {
        virtual bool IsInitialized() const = 0;
        virtual void Initialize(const Feature* gameFeatures, int numberOfFeatures) = 0;
        virtual bool GetFeatureEnabled(Feature feature) const = 0;
        virtual void SetFeatureEnabled(Feature feature, bool enabled, bool recordStatistics = true) = 0;
        virtual void RecordStateToStatistics() = 0;
    };
    ...
    struct TGI_TYPE_EXPORT ITobiiGameIntegrationApi
    {
        ...
        virtual IStatisticsRecorder* GetStatisticsRecorder() = 0;
        virtual IFeatures* GetFeatures() = 0;
        virtual IFeaturesEnabledSettings* GetFeaturesEnabledSettings() = 0;
